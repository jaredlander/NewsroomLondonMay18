...
# pharma.xlsx
download.file(
	'https://jaredlander.com/onsites/LondonMay18/BloombergData.xlsx',
	destfile=file.path(dataDir, 'pharma.xlsx'),
	mode='wb')

# kmart.html
download.file(
	'https://jaredlander.com/onsites/LondonMay18/KmartClosures.html',
	destfile=file.path(dataDir, 'kmart.html'),
	mode='w')
